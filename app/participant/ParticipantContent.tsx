...
import ParticipantMyParticipations from '../../components/ParticipantMyParticipations'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="md:grid md:grid-cols-2 md:gap-4">
          ...
          <div className={`${activeTab === 'home' ? 'block' : 'hidden'} md:block`}>
            ...
            {/* 내 참여 현황 */}
            <ParticipantMyParticipations getRequirements={getRequirements} handleCancelParticipation={handleCancelParticipation} />
          </div>
