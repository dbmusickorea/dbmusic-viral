  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4" style={{paddingTop: 'max(1rem, env(safe-area-inset-top))'}}>
      <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow p-6">
        ...
        <h1 className="text-xl font-bold mb-6 dark:text-white">이용약관</h1>
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-6">시행일: 2026년 7월 12일</p>

        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">제1조 (목적)</h2>
          <p className="text-sm text-gray-600 dark:text-gray-300">이 약관은 더블비뮤직(이하 "회사")이 제공하는 DBMUSIC 바이럴 마케팅 플랫폼 서비스의 이용 조건 및 절차, 회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
        </section>

        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">제2조 (정의)</h2>
        ...
        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">제3조 (약관의 효력 및 변경)</h2>
          <ul className="text-sm text-gray-600 dark:text-gray-300 mt-2 space-y-1 list-disc pl-4">
        ...
        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">제4조 (회원가입)</h2>
          <ul className="text-sm text-gray-600 dark:text-gray-300 mt-2 space-y-1 list-disc pl-4">
        ...
        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">제5조 (서비스 이용)</h2>
          <ul className="text-sm text-gray-600 dark:text-gray-300 mt-2 space-y-1 list-disc pl-4">
        ...
        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">제6조 (포인트 및 정산)</h2>
          <ul className="text-sm text-gray-600 dark:text-gray-300 mt-2 space-y-1 list-disc pl-4">
      ...
      <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="fixed bottom-6 right-4 w-10 h-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-full shadow-md flex items-center justify-center text-gray-500 dark:text-gray-400 z-50">↑</button>
    </div>
  )
}
