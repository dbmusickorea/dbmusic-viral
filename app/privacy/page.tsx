  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4" style={{paddingTop: 'max(1rem, env(safe-area-inset-top))'}}>
      <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow p-6">
        ...
        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">1. 개인정보 수집 항목</h2>
        ...
        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">3. 개인정보 보유 및 이용 기간</h2>
          <ul className="text-sm text-gray-600 dark:text-gray-300 mt-2 space-y-1 list-disc pl-4">
            <li>회원 탈퇴 시까지</li>
        ...
        <section className="mb-6">
          <h2 className="font-bold mb-2 dark:text-white">4. 개인정보의 제3자 제공</h2>
          <p className="text-sm text-gray-600 dark:text-gray-300">회사는 원칙적으로 이용자의 개인정보를 외부에 제공하지 않습니다. 단, 아래의 경우는 예외입니다.</p>
          <ul className="text-sm text-gray-600 dark:text-gray-300 mt-2 space-y-1 list-disc pl-4">
    ...
    {/* 스크롤 상단 버튼 */}
      <button
        ...
        className="fixed bottom-6 right-4 w-10 h-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-full shadow-md flex items-center justify-center text-gray-500 dark:text-gray-400 z-50"
      >
        ↑
      </button>
    </div>
