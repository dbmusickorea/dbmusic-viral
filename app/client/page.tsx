                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  {post.platform === 'instagram' && post.participant?.instagram_id && (
                                    <p className="text-xs text-gray-500 flex items-center gap-1">
                                      {post.participant?.profile_image_url ? (
                                        <img src={post.participant.profile_image_url} className="w-5 h-5 rounded-full" />
                                      ) : (
                                      ...
                                      @{post.participant.instagram_id.replace('@','')} ({post.participant.instagram_followers?.toLocaleString() ?? '-'}명)
                                    </p>
                                  )}
                                  {post.platform === 'youtube' && post.participant?.youtube_id && (
                                    <p className="text-xs text-gray-500 flex items-center gap-1">
                                      ...
                                      @{post.participant.youtube_id.replace('@','')} ({post.participant.youtube_subscribers?.toLocaleString() ?? '-'}명)
                                    </p>
                                  )}
                                  {post.platform === 'tiktok' && post.participant?.tiktok_id && (
                                    <p className="text-xs text-gray-500 flex items-center gap-1">
                                      ...
                                      @{post.participant.tiktok_id.replace('@','')} ({post.participant.tiktok_followers?.toLocaleString() ?? '-'}명)
                                    </p>
                                  )}
                                </div>
