export default function DistributionFooter({ fullBleed = true }: { fullBleed?: boolean }) {
  return (
    <div className={`${fullBleed ? 'md:mx-[calc(50%-50vw)]' : ''} border-t border-gray-200 dark:border-gray-700 mt-2`}>
