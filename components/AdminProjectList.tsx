    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow p-4 mb-4">
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="flex gap-2 text-xs">
          ...
          <span className="bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-300 px-2 py-1 rounded-full">완료 {projects.filter(p => p.status === 'COMPLETED').length}</span>
        </div>
      </div>
      {projects.length === 0 ? (
